 ...
 * <p>描述：定义一个下载的订阅者</p>
 */
public class DownloadSubscriber<R extends okhttp3.ResponseBody> extends BaseSubscriber<R> {
    ...
    public void onError(final ApiException e) {
        Logger.e("DownSubscriber:>>>> onError:" + e.getMessage());
        if (mCallBack != null) {
    ...
    public void onNext(R responseBody) {
        Logger.e("DownSubscriber:>>>> onNext");
    ...
    private boolean writeResponseBodyToDisk(String path, String name, Context context, okhttp3.ResponseBody body) {
        Logger.e("contentType:>>>>" + body.contentType().toString());
        ...
        try {
           ...
           /* if (!futureStudioIconFile.exists()) {
            ...
            try {
                ...
                outputStream.flush();
                Logger.e("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                ...
                if (callBack != null) {
                    ...
                    Logger.e("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                    Logger.e("file downloaded: is sucess");
                }
